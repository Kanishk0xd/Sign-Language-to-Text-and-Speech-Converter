...
cv2.imwrite(
    "C:\\Users\\devansh raval\\PycharmProjects\\pythonProject\\white.jpg", white
)
...
while True:
    try:
        ...
        if interrupt & 0xFF == ord("n"):
            ...
            flag = False
            count = len(
                oss.listdir("D:\\sign2text_dataset_3.0\\AtoZ_3.0\\" + (c_dir) + "\\")
            )
        ...
        if flag == True:
            ...
            if step % 3 == 0:
                cv2.imwrite(
                    "D:\\sign2text_dataset_3.0\\AtoZ_3.1\\"
                    + (c_dir)
                    + "\\"
                    + str(count)
                    + ".jpg",
