...
model = load_model(r"C:\\Users\\bhara\\Desktop\\sign_lang_conv\\Sign-Language-To-Text-and-Speech-Conversion\\cnn8grps_rad1_model.h5")
...
dicttt = {
    key: val
    for key, val in sorted(dicttt.items(), key=lambda ele: ele[1], reverse=True)
}
print(dicttt)
print(set(kok))
capture.release()
